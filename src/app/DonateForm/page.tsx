...
const Donate: React.FC = () => {
  ...
  return (
    ...
    {/* Header */}
    <Header />
    {/* {hospitalId && <p>Donating at Hospital ID: {hospitalId}</p>} */}
    {/* Main Content */}
    <main className="flex p-8 space-x-8">
      ...
      >
        ...
        <div className="bg-white shadow-lg rounded-lg p-4 w-full">
          <p className="text-black text-center text-2xl font-semibold p-4">
            {name}
          </p>
          <p className="text-black text-sm py-2 pl-2">
            {description}
          </p>
      ...
      {/* Right Section - Blood Donation Form */}
      <motion.div
        initial={{ opacity: 0, y: -20 }}
        animate={{ opacity: 1, y: 0 }}
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          {/* Parental Consent (Visible for Minors) */}
