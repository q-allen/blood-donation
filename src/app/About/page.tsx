...
const About: React.FC = () => {
  ...
  return (
    <motion.div
      className="bg-white text-gray-900 min-h-screen px-10 py-6 flex flex-col"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
    ...
    >
      ...
      <main className="flex-grow">
        <div className="flex flex-col md:flex-row items-center max-w-6xl mx-auto p-6 md:p-12 mt-20">
          <motion.div
