...
import { useRouter } from "next/navigation";
  ...
  >
    ...
    {/* Main Content */}
    <div className="flex flex-col md:flex-row items-center px-4 sm:px-6 lg:px-10 mt-12 sm:mt-16 lg:mt-20 relative z-0 pt-16 sm:pt-16 lg:pt-20"> {/* Content stays behind */}
      {/* Left Section */}
      <motion.div
